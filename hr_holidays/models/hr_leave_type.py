...
class HolidaysType(models.Model):
    ...
    leave_validation_type = fields.Selection([
        ...
        ('hr', 'Par le responsable des congés'),
        ('manager', "Par le supéieur hiérarchique"),
        ('both', "Par le supéieur  et le responsable des congés")], default='hr', string='Leave Validation')
