...
class RefZone(models.Model):
    ...
    libcourt = fields.Char(string="Libéllé court", size=35)
    ordre_validation = fields.Selection(string='Etape de validation',
                                        selection=[('1', 'Superviseur -> Comité Régional'),
                                                   ('2', 'Superviseur -> Comité Central'), ],
                                        required=False, default='1')
    service_client = fields.Char(string='Service Clientèle', required=False)
...
class RefRegion(models.Model):
    ...
    name = fields.Char(string="Libéllé ", required=True, track_visibility='always')
    libcourt = fields.Char(string="Code ", size=2, required=True, track_visibility='always')
    zone_id = fields.Many2one('ref_zone', string='Zone', required=True, track_visibility='always')
...
class HrUsers(models.Model):
    ...
    direction_id = fields.Many2one('hr.department', string='Direction', required=False)
    ...
    cpte_user = fields.Many2one(comodel_name='compta_plan_lines', string='Compte', required=False)
...
class RefCompte(models.Model):
    ...
    def insert_data(self):
        ...
        for val in self.env.cr.dictfetchall():
            ...
            fg_be, fg_bs) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s)""",
                                (cpte, scpte, lib, sens, lettrage, attente, finance, fg_be, fg_bs))
...
class BudgSignataire(models.Model):
    ...
    code = fields.Selection(
        [('1', 'DG'), ('2', 'DFC/DAF'), ('3', 'DCMEF/CG'), ('5', 'Compta Matière'), ('6', 'Magasinier/Fichiste')],
